...
export async function cleanTestData(): Promise<void> {
  ...
  await prisma.citizenVerification.deleteMany({ where: taskViaWhere })
  await prisma.taskMotionSummary.deleteMany({ where: taskViaWhere })
  await prisma.workerEnvironmentCapture.deleteMany({ where: taskViaWhere })
  await prisma.taskEnvironmentFingerprint.deleteMany({ where: taskViaWhere })
  await prisma.workerPointSubmission.deleteMany({ where: taskViaWhere })
  await prisma.taskReferencePoint.deleteMany({ where: taskViaWhere })
