...
import { Home, Bell, User, ShieldCheck } from 'lucide-react-native'
...
import { CitizenVerifyScreen } from '../screens/citizen/CitizenVerifyScreen'
...
function CitizenTabs() {
  return (
    <Tab.Navigator
      screenOptions={({ route }) => ({
        ...
        tabBarIcon: ({ color, size }) => {
          ...
          if (route.name === 'VerifyTasks')   return <ShieldCheck {...p} />
    ...
    >
      ...
      <Tab.Screen name="VerifyTasks"   component={CitizenVerifyScreen}  options={{ title: 'Verify' }} />
