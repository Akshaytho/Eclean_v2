        ...
        {last && (
          <>
            <Circle
              ...
              radius={30}
              fillColor={COLORS.brand.primary + '30'}
        ...
        <View style={styles.workerRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={styles.statusRow}>
              <View style={[styles.statusDot, { backgroundColor: last ? '#16A34A' : COLORS.neutral[400] }]} />
...
const styles = StyleSheet.create({
  ...
  workerDot:     { width: 22, height: 22, borderRadius: 11, backgroundColor: '#fff', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: COLORS.brand.primary },
  workerDotInner:{ width: 12, height: 12, borderRadius: 6, backgroundColor: COLORS.brand.primary },
  ...
  avatarBox:     { width: 44, height: 44, borderRadius: 22, backgroundColor: COLORS.brand.primary, alignItems: 'center', justifyContent: 'center' },
  avatarText:    { fontSize: 18, fontWeight: '700', color: '#fff' },
  workerName:    { fontSize: 16, fontWeight: '700', color: COLORS.neutral[900] },
  statusRow:     { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 2 },
  statusDot:     { width: 7, height: 7, borderRadius: 3.5 },
  statusText:    { fontSize: 12, color: COLORS.neutral[500] },
  timeBox:       { alignItems: 'center', gap: 2 },
  timeText:      { fontSize: 18, fontWeight: '800', color: COLORS.neutral[900] },
  timeLabel:     { fontSize: 10, color: COLORS.neutral[400] },
  gpsRow:        { flexDirection: 'row', alignItems: 'center', gap: 5 },
  gpsText:       { fontSize: 12, color: COLORS.neutral[400] },
})
